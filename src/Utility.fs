module DG.XrmTypeScript.Utility
...
/// https://github.com/Microsoft/TypeScript/blob/f2044a901165a2a97813772353b57dd9ed4796ca/src/compiler/checker.ts#L6555
let (|IsNumericLiteral|) (name: string) =
    match Double.TryParse name with
    | true, n -> n.ToString() = name
    | _ -> false
