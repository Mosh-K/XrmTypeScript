...
declare namespace Xrm {
    ...
    namespace Events {
         ...
         */
        interface EventContext<T extends FormContext = FormContext> {
            /**
         ...
         * @see {@link https://learn.microsoft.com/en-us/power-apps/developer/model-driven-apps/clientapi/reference/execution-context External Link: Execution context (Client API reference)}
         */
        interface LoadEventContext<T extends FormContext = FormContext> extends EventContext<T> {
            /**
             * @see {@link https://learn.microsoft.com/en-us/power-apps/developer/model-driven-apps/clientapi/reference/executioncontext/geteventargs#return-value External Link: getEventArgs (Client API reference)}
             */
         ...
         * @see {@link https://learn.microsoft.com/en-us/power-apps/developer/model-driven-apps/clientapi/reference/execution-context External Link: Execution context (Client API reference)}
         */
        interface PostSaveEventContext<T extends FormContext = FormContext> extends EventContext<T> {
            /**
        ...
        namespace Attribute {
            ...
            interface ChangeEventContext <T extends FormContext = FormContext> extends EventContext<T> {}
        }
     ...
     */
    interface Data<T extends AttributeCollection = AttributeCollection> {
        /**
    ...
    interface FormContext<
      A extends AttributeCollection = AttributeCollection,
      C extends ControlCollection = ControlCollection,
      T extends TabCollection = TabCollection,
      Q extends QuickFormCollection = QuickFormCollection,
    > {
        /**
    ...
    interface AttributeCollection extends Collection.ItemCollection<Attributes.Attribute> {}
    interface ControlCollection extends Collection.ItemCollection<Controls.Control> {}
    interface SectionCollection extends Collection.ItemCollection<Controls.Section> {}
    interface TabCollection extends Collection.ItemCollection<Controls.Tab> {}
    interface QuickFormCollection extends Collection.ItemCollection<Controls.QuickFormControl> {}
     ...
     * Interface for a Lookup value.
     */
    interface LookupValue<T extends string = string> {
        /**
         * The identifier.
         */
        id: string;
     ...
     * Interface for an OptionSet value.
     */
    interface OptionSetValue<T extends number = number> {
        /**
         * The label text.
         */
        text: string;
    ...
    namespace Attributes {
        ...
        interface OptionSetAttribute<T extends number = number> extends EnumAttribute<T> {
             ...
             * @returns The option.
             */
            getOption(value: T): OptionSetValue<T>;
             ...
             * @returns The option.
             */
            getOption(label: string): OptionSetValue<T>;

            /**
             * Gets all of the options.
             * @returns An array of options.
             */
            getOptions(): OptionSetValue<T>[];

            /**
             * Gets selected option.
             * @returns The selected option.
             */
            getSelectedOption(): OptionSetValue<T>;
         ...
         * @see {@link Attribute}
         */
        interface LookupAttribute<T extends string = string> extends Attribute<LookupValue<T>[]> {
            /**
             * Gets the attribute type.
             */
             ...
             * @see {@link https://learn.microsoft.com/en-us/power-apps/developer/model-driven-apps/clientapi/reference/collections External Link: Collections (Client API reference)}
             */
            controls: Collection.ItemCollection<Controls.LookupControl<T>>;
        }
    }
    ...
    namespace Controls {
         ...
         */
        interface UiCanGetOptionsElement<T extends number = number> {
            /**
         ...
         * @see {@link StandardControl}
         */
        interface LookupControl<T extends string = string> extends StandardControl {
            /**
             ...
             * @returns The attribute.
             */
            getAttribute(): Attributes.LookupAttribute<T>;
         ...
         * @see {@link StandardControl}
         */
        interface OptionSetControl<T extends number = number> extends StandardControl, UiCanGetOptionsElement<T> {
            /**
             * Adds an option.
             *
             ...
             */
            addOption(option: OptionSetValue<T>, index?: number): void;
             ...
             * @returns The attribute.
             */
            getAttribute(): Attributes.OptionSetAttribute<T>;
        ...
        interface MultiSelectOptionSetControl<T extends number = number> extends StandardControl, UiCanGetOptionsElement<T> {
            /**
             * Adds an option.
             *
             * @param option The option.
             ...
             * @returns The attribute.
             */
            getAttribute(): Attributes.MultiSelectOptionSetAttribute<T>;
         ...
         * @see {@link UiFocusable}
         */
        interface Tab<T extends SectionCollection = SectionCollection> extends UiStandardElement, UiFocusable {
            /**
         ...
         * @see {@link UiStandardElement}
         */
        interface Section<T extends ControlCollection = ControlCollection> extends UiStandardElement {
            /**
     ...
     * @see {@link https://learn.microsoft.com/en-us/power-apps/developer/model-driven-apps/clientapi/reference/formcontext-data-entity External Link: formContext.data.entity (Client API reference)}
     */
    interface Entity<T extends AttributeCollection = AttributeCollection> {
        /**
